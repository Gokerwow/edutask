...
@section('content')
    <div class="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div class="flex justify-between items-center mb-8">
            ...
            <a href="{{ route('lecture.show', ['id' => $lecture->id]) }}" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300 transition flex items-center">
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="border border-gray-200 rounded-md p-4 hover:bg-gray-50 transition flex items-center">
                            <div class="mr-4">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-red-500" viewBox="0 0 384 512" fill="currentColor">
                            ...
                            <div>
                                ...
                                <a href="{{ route('materi.download', ['lecture' => $lecture, 'materi' => $materi]) }}" class="mt-2 text-sm text-indigo-600 hover:text-indigo-800 flex items-center">
            ...
            @if($isTentor)
                ...
                <div class="bg-gray-50 px-6 py-4 border-t flex justify-end gap-2">
                    <a href="{{ route('materi.edit', ['lecture' => $lecture, 'materi' => $materi]) }}" class="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-blue-700 transition flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
