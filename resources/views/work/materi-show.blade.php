...
@section('content')
    <div class="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div class="flex justify-between items-center mb-8">
            ...
            <a href="{{ url()->previous() }}" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300 transition flex items-center">
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div class="bg-gray-50 px-6 py-4 border-t flex justify-end">
                <button class="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-blue-700 transition flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
