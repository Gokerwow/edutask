...
@section('content')
    <div class="bg-white p-8 sm:p-12 rounded-xl shadow-xl w-full max-w-2xl place-self-center my-10">
        ...
        <form action="{{ route('lecture.store') }}" method="POST" class="space-y-7" id="createClassForm"
            ...
            <div>
                ...
                <div class="mt-1.5 w-full">
                    <label id="cover-upload-label" for="cover-upload"
                        class="relative flex flex-col items-center justify-center w-full h-48 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 hover:border-orange-400 transition-colors duration-200">

                        {{-- Tampilan Awal (Prompt Unggah) --}}
                        ...
                        {{-- Tampilan Pratinjau (Awalnya tersembunyi) --}}
                        <div id="image-preview-container" class="hidden absolute inset-0 w-full h-full">
                            ...
                            <button type="button" id="remove-image-btn"
                                class="absolute top-2 right-2 bg-white/70 backdrop-blur-sm text-red-500 rounded-full p-1.5 shadow-md hover:bg-white transition-all">
            ...
            <div class="pt-8 space-y-4">
                ...
                <a href="{{ route('lecture.index') }}" class="btn-secondary-orange">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
