    ...
    <main class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div class="relative w-full sm:w-64">
                <div class="relative flex items-center border border-gray-300 rounded-lg ">
                    ...
                    <input wire:model.live.debounce.300ms='queries' type="text" placeholder="Search classes..."
                        class="w-full py-2 pl-10 pr-3 focus:ring-indigo-500 focus:border-indigo-500 rounded-lg">
                </div>
            </div>
                        ...
                        <g id="SVGRepo_iconCarrier">
                            ...
                            <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"
                                ...
                                <g id="Icon-Set" sketch:type="MSLayerGroup"
                                    transform="translate(-516.000000, -99.000000)" fill="#ffffff">
                                    <path
        ...
        <x-modal class="relative" name="joinClassModal" maxWidth="md">
            <div class="z-30 p-8 bg-white w-full max-w-md m-auto flex-col flex justify-center rounded-lg shadow-lg">
                ...
                <form action="{{ route('lecture.join') }}" method="POST">
                    @csrf
                    <div>
                        <label for="class_code" class="block text-sm font-medium text-gray-700 mb-1">Kode
                            Kelas</label>
                    ...
                    <div class="mt-4 text-center">
                        <button type="button" x-data x-on:click="$dispatch('close-modal', 'joinClassModal')"
                        ...
                        <div class="p-5">
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="text-sm text-gray-600">{{ $joinedLecture->lecture->tentor->name }}</span>
                                </div>
                                <div class="text-sm text-gray-500 flex items-center gap-2">
                                    <svg class="w-4 h-4" viewBox="0 -0.5 25 25" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
        ...
        @else
            ...
            <div class="text-center flex flex-col justify-center items-center py-12 min-h-[350px]">
                ...
                <div
                    class="w-fit flex items-center mt-1 px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700">
                    <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
