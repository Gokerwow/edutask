        ...
        <aside class="w-full lg:w-1/4">
            <div class="bg-white rounded-xl shadow-md overflow-hidden sticky top-[100px] ">
                ...
                <nav class="p-4">
                    <ul class="space-y-2">
                        <li>
                            <a href="#" wire:click='active("dashboard")' class="flex items-center px-4 py-3 rounded-lg {{ $activeMainTab === 'dashboard' ? 'bg-indigo-50 text-indigo-600' : 'hover:bg-gray-100 text-gray-700'}} transition">
                        ...
                        <li>
                            <a href="#" wire:click='active("nilaiTab")' class="flex items-center px-4 py-3 rounded-lg {{ $activeMainTab === 'nilaiTab' ? 'bg-indigo-50 text-indigo-600' : 'hover:bg-gray-100 text-gray-700'}} transition">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <li>
                            <a href="#" wire:click='active("partisipanTab")' class="flex items-center px-4 py-3 rounded-lg {{ $activeMainTab === 'partisipanTab' ? 'bg-indigo-50 text-indigo-600' : 'hover:bg-gray-100 text-gray-700'}} transition">
