...
<div class="">
    ...
    <div class="text-white mb-5">
        ...
        <div class="text-sm text-gray-300 flex gap-1">
            ...
            <a href="{{ route('register') }}" class="text-orange-500 hover:text-orange-600">Daftar Sekarang!</a>
        </div>
    </div>
    ...
    <form wire:submit="login">
        ...
        <h1 class="text-center text-white text-xl mt-5">Atau</h1>

        <!-- From Uiverse.io by TreepDeep -->
        <a href="{{ route('google.redirect') }}" class="button google place-self-center my-5">
