    <!-- Footer -->
    <footer class="bg-[linear-gradient(135deg,#f97316_0%,#7e22ce_100%)] text-white pt-12 pb-6 border-t-4">
        <div class="container mx-auto px-4">
            <div class="flex flex-col md:flex-row justify-between">
                ...
                <div class="w-full md:w-1/3 mb-8 md:mb-0">
                    <div class="flex items-center mb-4 gap-3">
                        <!-- Logo -->
                        <div class="bg-white rounded-full w-10">
                            <img src="{{ asset('images/logo/EdutaskLOGO2.png') }}" alt="">
                        </div>
                        <h2 class="text-2xl font-bold">Edu<span class="text-orange-300">Task</span></h2>
                    </div>
                    <p class="text-purple-100 mb-4">Kami memberikan solusi terbaik untuk kebutuhan digital Anda dengan inovasi dan kreativitas.</p>
            ...
            <div class="border-t border-purple-300 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
                ...
                <div class="flex space-x-6">
                    ...
                    <a href="#" class="text-purple-100 hover:text-orange-300 transition">Sitemap</a>
                </div>
            </div>
        </div>
    </footer>
