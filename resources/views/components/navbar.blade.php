        ...
        @auth
            <div x-data="{ open: false }" class="relative inline-block text-left">
                <button @click="open = !open"
                    class="flex items-center space-x-2 bg-white text-gray-800 px-4 py-2 rounded-lg hover:bg-gray-300">
                    @if (auth()->user()->avatar)
                        ...
                        <ul class="space-y-2 text-sm">
                            <li>
                                <a href="{{ route('profile') }}"
                                    class="flex items-center justify-between hover:text-purple-500">
                                    <span class="flex items-center gap-2"><i class="fas fa-cog"></i> Settings &
                                        Privacy</span>
                            ...
                            <li>
                                <a href="#" class="flex items-center justify-between hover:text-purple-500">
                                    <span class="flex items-center gap-2"><i class="fas fa-question-circle"></i> Help &
                                        Support</span>
                                    <i class="fas fa-chevron-right text-xs"></i>
                                </a>
                            </li>
